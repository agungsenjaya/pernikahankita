...
<div class="modal fade" id="modalClient" tabindex="-1" aria-labelledby="modalClientLabel" aria-hidden="true">
  <div class="modal-dialog modal-fullscreen">
    ...
    <div class="d-flex align-items-center min-vh-100 container text-center">
        ...
        <h1 class="display-1 w-1 mb-0 text-white">Dita & Dika</h1>
        <p class="lead text-white">Minggu, 22 Mei 2022</p>
...
<div class="to-center grad-1 d-flex align-items-center text-center text-white">
    <div class="container">
        ...
        <h1 class="display-1 w-1 mb-0">Dita & Dika</h1>
        <p class="lead">Minggu, 22 Mei 2022</p>
    </div>
</div>
</div>
<div class="position-relative">
    ...
    <div class="container">
        ...
        <div class="row justify-content-center text-center">
            <div class="col-md-4" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="100">
                <div class="card bg-transparent border-0 card-body">
                    <div class="text-center position-relative">
                        <img src="{{ asset('img/client/5.png') }}" alt="" class="rounded-pill" width="70%">
                        <div class="to-center" style="z-index:-1;margin-left: 4px;margin-top: -14px;">
                            <img src="{{ asset('img/shape-3.png') }}" alt="" class="" width="100%">
                        </div>
                    </div>
                    <div class="card-body">
                        <h3 class="w-1 text-primary">Nadita Anandita</h3>
                        <div class="mb-2">
                            <a href="https://www.instagram.com/anandit1" target="_blank">
                                <i class="bi bi-instagram"></i>
                            </a>
                        </div>
                        <div class="badge bg-primary mb-2">Mempelai Wanita</div>
                        <div>
                            <p class="lead">Putri dari <br> Bapak Nurdin Muhtar dan Ibu Aminah</p>
                        </div>
                </div>
            </div>
        </div>
            <div class="col-md-4" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="200">
                <div class="card bg-transparent border-0 card-body">
                <div class="text-center position-relative">
                        <img src="{{ asset('img/client/6.png') }}" alt="" class="rounded-pill" width="70%">
                        <div class="to-center" style="z-index:-1;margin-left: 4px;margin-top: -14px;">
                            <img src="{{ asset('img/shape-3.png') }}" alt="" class="" width="100%">
                        </div>
                    </div>
                    <div class="card-body">
                        <h3 class="w-1 text-primary">Andika Permana</h3>
                        <div class="mb-2">
                            <a href="https://www.instagram.com/dika.15_" target="_blank">
                                <i class="bi bi-instagram"></i>
                            </a>
                        </div>
                        <div class="badge bg-primary mb-2">Mempelai Pria</div>
                        <div>
                            <p class="lead">Putra dari <br> Bapak Tatang Sutarman dan Ibu Lilis Lasmawati</p>
                        </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-4 mb-4 mb-md-0" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="200">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <hr>
                        <h5 class="fw-bold text-primary">Prumahan Permata Halimun Blok D 5.</h5>
                        <p>Jalan lembur pasir/ Pondok Halimun /slabintana kec. Sukabumi</p>
                        <p><i class="bi bi-clock-fill me-2 text-primary"></i>09.00 WIB</p>
                    </div>
                    <a class="card-footer bg-primary text-white p-3" href="https://goo.gl/maps/Aob6tWaU8QRW2x889" target="_blank">
                        Open Gmaps
                    </a>
                </div>
            </div>
...
<section class="space-m" id="gallery" style="overflow:hidden">
    ...
    <div class="swiper slider-2" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
      ...
      <div class="swiper-slide">
            <a data-fancybox="pot" data-src="https://lh3.googleusercontent.com/pw/AM-JKLV4PKOfmRTCreoZKw4DyJkgRE-tnHeHZu5KWv5u9g74vXXyjhixFDcMKPF1uSADYwXQeNKq7GR3TPWDh4D9zpEk-p8fBF7VtkMK06CZ2tNEyxgROK_mZyw11s7WuViwypQ8xQ8mEGgjw09d3XcS-CKj=w432-h649-no" data-caption="Dita & Dika" class="point">
        ...
        <div class="swiper-slide">
            <a data-fancybox="pot" data-src="https://lh3.googleusercontent.com/pw/AM-JKLVggz_cksE_5hHZ-U6GcyCWhSdBx0MJQU6RlJe_1wtXz3RW1OEWvCl3cEU2jEMUoxWn6QBD5Ny_L8TQb2kR9laqyuI29wxpqcak6qx24EBAvXmQr-9tNEWxfdawenlgXEgmNmeSOCVQAsmrwV7dCw4r=w432-h649-no" data-caption="Dita & Dika" class="point">
        ...
        <div class="swiper-slide">
            <a data-fancybox="pot" data-src="https://lh3.googleusercontent.com/pw/AM-JKLUZYmJyR5pTzPssI37hPuP4b_HYDzXkW4zrbDrJAVQA_P_N_upnmCflG2oRfhZ75WaShxH-Gwpn6Ym24dHhWExaNCDQOGvNi7d6p3idCfcLB4HVS41b30PiT5vZjmEhcIsKSodNpyr07BnvSMdc803U=w432-h649-no" data-caption="Dita & Dika" class="point">
        ...
        <div class="swiper-slide">
            <a data-fancybox="pot" data-src="https://lh3.googleusercontent.com/pw/AM-JKLX1-wJ9beb2O-BG-5159rMMWY6ignjfWVuWrQc97ERmIxUSLKqP7R8a4gr9tCd8WCbr5rAa2N12YX5LMPTY0Z_88-6m0Hm-ZjsnJ9U89jpJepTDbQa4l_NSqo7r1vphlqlSmlanHejBZaJAHfNT_Q7r=w432-h649-no" data-caption="Dita & Dika" class="point">
        ...
        <div class="swiper-slide">
            <a data-fancybox="pot" data-src="https://lh3.googleusercontent.com/pw/AM-JKLWAXspAYHx8xbpmc09vF3qWw5FH-a04DmHqbkLG0k2EaQWyqWTjMCmXwU4-wKExxfOrHhf_InAimoHhGGONP2dy_fampHguKLuQRVWzWKhhjoYWGHaw1-jHYe2iTbD0VFDZlyAPU8zs4iLJBldL_75p=w432-h649-no" data-caption="Dita & Dika" class="point">
        ...
        <div class="swiper-slide">
            <a data-fancybox="pot" data-src="https://lh3.googleusercontent.com/pw/AM-JKLWPCiGpx-T2vgmbL4HXOyOy-I40Cpepf9Rs7WY2BwSj2eWv9C230Zgcb-FhpQ2d_tO50fn8m_sTcUWQoetCSJ22r_KcXSkDjTJoC30zYvYYFjsFmylcrcAn2Cj3QfOB2VUajHkyoYxlaFfRv0ByqnEG=w432-h649-no" data-caption="Dita & Dika" class="point">
        ...
        <div class="swiper-slide">
            <a data-fancybox="pot" data-src="https://lh3.googleusercontent.com/pw/AM-JKLVftWBfiEzgGK5d7jBxRsmoFq6um0Kc2V1HrkK5QD8G8ViyL4ZARWZ8ICGEy6cweey7EBmZqXL-MCMMj4y9eyZLiLP7zo-0a-OfBwxljSLXf5esdYmVxIbtuXnbA7N-GgHN6jvQx_xtHtMeGdAGWSkp=w432-h649-no" data-caption="Dita & Dika" class="point">
        ...
        <div class="swiper-slide">
            <a data-fancybox="pot" data-src="https://lh3.googleusercontent.com/pw/AM-JKLV6cvSYRSQv-pBOrzSTxL9Mnt_GD3yOTceWOkPT-Zk5yEpoPmy06B1fAgDixiiUpcXx0EVwxXVsW5rG2JXprhsZUs_MEN5_7Y7FbG1u01bhVn4NqKa0ynVgBLwFTfHx_E9RbNuz9jZ0e4uJK3wCrMnN=w432-h649-no" data-caption="Dita & Dika" class="point">
        ...
        <div class="swiper-slide">
            <a data-fancybox="pot" data-src="https://lh3.googleusercontent.com/pw/AM-JKLWNSSL0En87fSJW3xMoC3lFoFNSCVmEL_AcGnDm5egu1YwR1N7eFF74TUrC0nZO4j8neb6Bl8l9Wsr2_fbiOxMffSZ8c2yCpSqnEVmeiVHsVG5ZBCEL7EGIvYyOTCixg-VO4jKdGJltWKePPr3Ro3Q4=w432-h649-no" data-caption="Dita & Dika" class="point">
        ...
        <div class="swiper-slide">
            <a data-fancybox="pot" data-src="https://lh3.googleusercontent.com/pw/AM-JKLX0btSeG3TzTkRzgLEjqX4snrSrbYtYu2vHJgdLyTsww8Zz1prCYgHnV5U8tH4l1anQkm0u1aD4rfg100q3kA6AQ8bxOkzW3oid_H0DJSY6JmQKOM0tlhfl2iJTIXa74oqH1fEJ5xtoLse1HFT3uBt_=w432-h649-no" data-caption="Dita & Dika" class="point">
        ...
        <div class="swiper-slide">
            <a data-fancybox="pot" data-src="https://lh3.googleusercontent.com/pw/AM-JKLU3VfR87T4ANgV38NP_-QpdOjyX0OFUjZ2fmKnpQklgu-Bb3oKJ3pbKWEJFPXO8N-1GeRdHd4nTSkjVPOdK3fx6JxMUe3pzYoS6nTCJ27IVJePxIarDVdfu0G_tRRcKb5LU5mRsrDDMiZoviuj1EEfk=w432-h649-no" data-caption="Dita & Dika" class="point">
...
<script>
    ...
    var swiper1 = new Swiper(".slider-1", {
      ...
      $('#countdown').countdown('2022/05/22', function(event) {
...
@endsection
@section('meta')
<title>Pernikahankita.id | Dita & Dika</title>
<meta itemprop="name" content="Pernikahankita.id | Dita & Dika">
<meta itemprop="description" content="The wedding of Dita & Dika. Minggu, 22 Mei 2022">
<meta itemprop="image" content="{{ asset('img/client/meta-3.jpg') }}">

<meta name="twitter:title" content="Pernikahankita.id | Dita & Dika">
<meta name="twitter:description" content="The wedding of Dita & Dika. Minggu, 22 Mei 2022">
<meta name="twitter:image:src" content="{{ asset('img/client/meta-3.jpg') }}">
<meta name=twitter:card content="summary_large_image">

<meta property="og:title" content="Pernikahankita.id | Dita & Dika" />
<meta property="og:image" content="{{ asset('img/client/meta-3.jpg') }}" />
<meta property="og:description" content="The wedding of Dita & Dika. Minggu, 22 Mei 2022" />
