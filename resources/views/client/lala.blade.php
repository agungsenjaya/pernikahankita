...
<section class="space-m" id="profile" style="overflow:hidden">
    <div class="container">
        <div class="text-center" data-aos="zoom-out" data-aos-duration="1000">
            <h1 class="w-1">Calon Pengantin</h1>
        </div>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-4" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="200">
                <div class="card h-100">
                <img src="{{ asset('img/client/gallery/land/DSA_8280.jpg') }}" alt="" class="card-img-top">
                    <div class="card-body">
...
<meta property="og:description" content="The wedding of lala dan andri. Minggu, 06 Febuari 2022" />
